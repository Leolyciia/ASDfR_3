  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: example_a
  {
    cdr << ros_message->example_a;
  }

  // Field name: example_b
  {
    cdr << ros_message->example_b;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name example_a
  {
    size_t item_size = sizeof(ros_message->example_a);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name example_b
  {
    size_t item_size = sizeof(ros_message->example_b);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
