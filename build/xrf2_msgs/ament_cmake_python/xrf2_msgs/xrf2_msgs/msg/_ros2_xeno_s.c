...
bool xrf2_msgs__msg__ros2_xeno__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // example_a
    PyObject * field = PyObject_GetAttrString(_pymsg, "example_a");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->example_a = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // example_b
    PyObject * field = PyObject_GetAttrString(_pymsg, "example_b");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->example_b = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * xrf2_msgs__msg__ros2_xeno__convert_to_py(void * raw_ros_message)
{
  ...
  {  // example_a
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->example_a);
    {
      int rc = PyObject_SetAttrString(_pymessage, "example_a", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // example_b
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->example_b);
    {
      int rc = PyObject_SetAttrString(_pymessage, "example_b", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
