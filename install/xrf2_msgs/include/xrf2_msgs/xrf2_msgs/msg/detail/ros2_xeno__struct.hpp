...
struct Ros2Xeno_
{
  ...
  using _example_a_type =
    double;
  _example_a_type example_a;
  using _example_b_type =
    double;
  _example_b_type example_b;
  ...
  {
    if (this->example_a != other.example_a) {
      return false;
    }
    if (this->example_b != other.example_b) {
      return false;
    }
    return true;
  }
