...
class Xeno2Ros(metaclass=Metaclass_Xeno2Ros):
    ...
    def encoder_left(self, value):
        if __debug__:
            assert \
                ...
                "The 'encoder_left' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'encoder_left' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def encoder_right(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'encoder_right' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'encoder_right' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
